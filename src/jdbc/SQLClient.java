...
public class SQLClient extends Application {
	...
	public void start(Stage primaryStage) {
		cboURL.getItems().addAll(FXCollections.observableArrayList("jdbc:postgresql://localhost/hola_perro",
	 ...
	 "com.mysql.jdbc.Driver", "sun.jdbc.odbc.dbcOdbcDriver","org.postgresql.Driver",
